...
class ImgsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create img" do
    assert_difference('Img.count') do
      post imgs_url, params: { img: { link: @img.link, nome: @img.nome, traducao: @img.traducao } }
    end
  ...
  test "should update img" do
    patch img_url(@img), params: { img: { link: @img.link, nome: @img.nome, traducao: @img.traducao } }
